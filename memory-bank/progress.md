...
| M13 Step 2/5: VllmWorkerBackend 原型 | **已完成** | [2026-05-24] Rust `VllmWorkerBackend` (JSON-over-stdio pipe) + Python `hcp_worker_process.py` (mock/transformers/vllm 三后端)。`--backend-type` CLI 参数支持 tch/vllm 切换。53/53 tests passed。Commit `cc9f5c0` |
