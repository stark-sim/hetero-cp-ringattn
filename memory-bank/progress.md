...
- [x] [2026-06-13] **A100 (4x A100-SXM4-40GB) HCP 验证全部完成**：
  ...
  - 完整报告沉淀：`docs/A100_VALIDATION_REPORT.md`
...
| **M14: 1M Context + 2.5G 有线直连本地异构验证** | **已规划 / Phase 0 完成** | [2026-06-16] 战略优先级最高：white RTX 4090 CUDA + pearl RX 9060 XT HIP 通过 2.5G 有线直连验证 HCP 在 1M context 的可行性。原 Thunderbolt 方案放弃。网络基线完成：有线 ~2.35 Gbps 双向对称 / RTT ~0.1 ms；WiFi ~250 Mbps；Tailscale 严重不对称。0.5B 模型为首目标。计划文档：`docs/1M_CONTEXT_THUNDERBOLT_PLAN.md` |
