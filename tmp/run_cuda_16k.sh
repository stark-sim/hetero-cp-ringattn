...
time "$BINARY" --distributed-role coordinator \
    ...
    > /tmp/coord_cuda_16k.log 2>&1

echo "=== COORD ==="
cat /tmp/coord_cuda_16k.log | tail -10
echo "=== W0 ==="
cat /tmp/worker0_cuda_16k.log | tail -5
echo "=== W1 ==="
cat /tmp/worker1_cuda_16k.log | tail -5
